...
const MOCK_DATA = [
    { worker_id: "W-1001", amount: "500.00", asset: "USDC", setup_date: "2026-02-01", payout_date: "2026-02-15", status: "Paid" },
    { worker_id: "W-1002", amount: "750.00", asset: "USDC", setup_date: "2026-02-01", payout_date: "2026-02-15", status: "Paid" },
    { worker_id: "W-1003", amount: "1200.00", asset: "XLM", setup_date: "2026-02-05", payout_date: "2026-02-28", status: "Pending" },
    { worker_id: "W-1004", amount: "400.00", asset: "USDC", setup_date: "2026-02-10", payout_date: "2026-02-28", status: "Pending" },
    { worker_id: "W-1005", amount: "3000.00", asset: "XLM", setup_date: "2026-01-15", payout_date: "2026-01-31", status: "Paid" },
];
...
const CustomReportBuilder = () => {
    ...
    const handleExport = () => {
        ...
        alert(`Exporting ${filteredData.length} records with columns: ${activeColumns.map(c => c.label).join(", ")}`);
    };
    ...
    return (
        <div className="p-8 max-w-7xl mx-auto space-y-8">
            <div>
                ...
                <p className="text-gray-600">Select columns and date ranges to preview and export custom payroll data.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div className="md:col-span-1 space-y-6 flex flex-col">
                    ...
                    <Button onClick={handleExport} variant="primary" size="md" className="w-full flex justify-center mt-auto">
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            ...
                                            {filteredData.length === 0 && (
                                                <tr>
                                                    <td colSpan={activeColumns.length} className="px-6 py-8 text-center text-gray-500">
